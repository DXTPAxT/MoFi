        ...
        <aside className={cx('wrapper', 'col-3', 'h100')}>
            <div className={cx('inner')}>
                <div className={cx('account-container')}>
                                        ...
                                        <div>
                                            ...
                                            <div className={cx('account-noti-list')}>
                                                <div className={cx('account-noti')}>
                                                    <div
                                                        className={cx(
                                                            'account-noti-content',
                                                        )}
                                                    >
                                                        This is the content of the first
                                                        notification, This is the content
                                                        of the first notification, This is
                    ...
                    >
                        <div
                            className={cx('account-noti-container')}
                            onClick={visible1 ? hide : show}
                        >
                            <span
                                className={cx('account-noti-count', noti ? null : 'hide')}
                            >
                                {noti !== 0 ? noti : null}
                            </span>
                            <Icon
                                icon="solar:bell-bold"
                                className={cx('account-noti-icon')}
                            />
                        </div>
                    </Tippy>
